...
public class ServiceTests extends GameTests {
    ...
    public void logoutTestValid() throws DataAccessException {
        ...
        Assertions.assertThrows(DataAccessException.class, () -> userService.logout(registered.authToken()), "logout failed");
    }
    ...
    public void createTestInvalid(){
        Assertions.assertThrows(DataAccessException.class, () -> gameService.createGame("this is not a real token", "034"));
    }
    ...
    public void joinTestInvalid() throws DataAccessException {
        var jimmer = userService.register("Jimmer", "32", "Jimmer@mail.com");
        Assertions.assertThrows(DataAccessException.class, () -> gameService.joinGame(jimmer.authToken(), 9999, "WHITE"), "no 9999 id");
    }
